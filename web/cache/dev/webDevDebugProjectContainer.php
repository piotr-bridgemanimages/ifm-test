...
/**
 * webDevDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class webDevDebugProjectContainer extends Container
{
    private $parameters;
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'slaves' => array('slave1' => array('host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ifm', 'user' => 'dbuser', 'password' => 'dbuser')), 'driverOptions' => array(), 'master' => array('host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ifm', 'user' => 'dbuser', 'password' => 'dbuser', 'charset' => 'UTF8', 'defaultTableOptions' => array()), 'wrapperClass' => 'Doctrine\\DBAL\\Connections\\MasterSlaveConnection'), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9ed625f181a4292a05696aa8f27dde356e12249b82519c2805884092e3c4d864');
    ...
    {
        $this->services['router'] = $instance = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'kernel:loadRoutes', array('cache_dir' => __DIR__, 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'webDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'webDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'service'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'webDevDebugProjectContainer',
            'database_master_host' => '127.0.0.1',
            'database_master_port' => NULL,
            'database_master_name' => 'ifm',
            'database_master_user' => 'dbuser',
            'database_master_password' => 'dbuser',
            'database_slave1_host' => '127.0.0.1',
            'database_slave1_port' => NULL,
            'database_slave1_name' => 'ifm',
            'database_slave1_user' => 'dbuser',
            'database_slave1_password' => 'dbuser',
            'database_fixtures_host' => '127.0.0.1',
            'database_fixtures_port' => NULL,
            'database_fixtures_name' => 'ifm_fixtures',
            'database_fixtures_user' => 'dbuser',
            'database_fixtures_password' => 'dbuser',
            ...
            'router.options.matcher.cache_class' => 'webDevUrlMatcher',
            'router.options.generator.cache_class' => 'webDevUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => 'kernel:loadRoutes',
            'router.cache_class_prefix' => 'webDev',
            'request_listener.http_port' => 80,
            'request_listener.https_port' => 443,
            'debug.error_handler.throw_at' => -1,
            'debug.container.dump' => (__DIR__.'/webDevDebugProjectContainer.xml'),
